...
void Painter::randomColor()
{
    ...
    SDL_Color colorList[] = {CYAN_COLOR, BLUE_COLOR, ORANGE_COLOR, YELLOW_COLOR, LIME_COLOR, PURPLE_COLOR, RED_COLOR, WHITE_COLOR, BLACK_COLOR, GREEN_COLOR};
    this->color = colorList[rand() % (sizeof(colorList) / sizeof(SDL_Color))];
}
